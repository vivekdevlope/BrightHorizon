// src/pages/user/SapBtpDevelopment.jsx
        ...
        <section className="flex-1 flex items-center justify-center px-6 md:px-20 py-16 md:py-24">
          <div className="max-w-5xl mx-auto text-center text-white z-10">
            ...
            <p className="text-lg md:text-2xl opacity-95 max-w-3xl mx-auto drop-shadow-md">
              Build intelligent cloud extensions with SAP BTP.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 transition-all hover:shadow-xl">
              ...
              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                <span className="font-semibold text-cyan-600">BrightHorizon Infotech</span> helps you
                extend SAP with cloud-native applications using SAP Business Technology Platform.
              </p>

              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                From side-by-side extensions to microservices and AI integrations, we
                leverage SAP BTP, CAP, Kyma, and Fiori to deliver scalable, secure solutions.
              </p>

              <p className="text-lg leading-relaxed text-slate-700">
                With <span className="font-semibold text-cyan-600">BrightHorizon Infotech</span>, transform
                your SAP landscape into a future-ready intelligent enterprise.
              </p>
            </div>

            {/* Navigation Buttons – First Page (Only Next + All Services) */}
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12 items-center">
              ...
              >
                Next: SAP CPI <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </section>
