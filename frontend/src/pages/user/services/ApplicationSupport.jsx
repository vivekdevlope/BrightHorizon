// src/pages/user/ApplicationSupport.jsx
        ...
        <section className="flex-1 flex items-center justify-center px-6 md:px-20 py-16 md:py-24">
          <div className="max-w-5xl mx-auto text-center text-white z-10">
            ...
            <p className="text-lg md:text-2xl opacity-95 max-w-3xl mx-auto drop-shadow-md">
              24/7 SAP system reliability, performance, and uptime.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 transition-all hover:shadow-xl">
              ...
              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                <span className="font-semibold text-green-600">BrightHorizon Infotech</span> offers
                comprehensive SAP AMS — ensuring your systems are monitored, optimized,
                and supported around the clock.
              </p>

              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                With proactive monitoring, incident resolution, performance tuning,
                and upgrade support, we reduce downtime and keep your SAP landscape
                running at peak efficiency.
              </p>

              <p className="text-lg leading-relaxed text-slate-700">
                With <span className="font-semibold text-green-600">BrightHorizon Infotech</span>,
                focus on strategy while we manage your SAP operations with care and precision.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12 items-center">
              ...
              >
                <ArrowLeft size={20} /> Prev: Staffing Augmentation
              </button>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-full font-semibold text-base transition-all duration-300 shadow-md hover:shadow-xl transform hover:scale-105 active:scale-95 w-full sm:w-auto"
              >
                Next: Application Development <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </section>
