// src/pages/user/ProductEngineering.jsx
import React, { useEffect } from "react";
import { useNavigate } from "react-router-dom";
import { FileCode, ArrowLeft, ArrowRight } from "lucide-react";
        ...
        <section className="flex-1 flex items-center justify-center px-6 md:px-20 py-16 md:py-24">
          <div className="max-w-5xl mx-auto text-center text-white z-10">
            ...
            <p className="text-lg md:text-2xl opacity-95 max-w-3xl mx-auto drop-shadow-md">
              From ideation to deployment — build SAP-integrated products.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 transition-all hover:shadow-xl">
              ...
              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                <span className="font-semibold text-teal-600">BrightHorizon Infotech</span> offers
                end-to-end product engineering services — turning your vision into scalable,
                SAP-integrated digital products.
              </p>

              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                We follow agile methodologies, design thinking, and DevOps to deliver MVPs,
                full-scale platforms, and continuous enhancements — all seamlessly connected
                to your SAP backend via BTP, CPI, or Fiori.
              </p>

              <p className="text-lg leading-relaxed text-slate-700">
                With <span className="font-semibold text-teal-600">BrightHorizon Infotech</span>,
                launch market-ready products faster, with lower risk and higher ROI.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12 items-center">
              ...
              >
                <ArrowLeft size={20} /> Prev: SAP Cloud Platform
              </button>
              ...
              >
                Next: Mobile Development <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </section>
