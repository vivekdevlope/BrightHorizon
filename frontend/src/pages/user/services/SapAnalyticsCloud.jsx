// src/pages/user/SapAnalyticsCloud.jsx
        ...
        <section className="flex-1 flex items-center justify-center px-6 md:px-20 py-16 md:py-24">
          <div className="max-w-5xl mx-auto text-center text-white z-10">
            ...
            <p className="text-lg md:text-2xl opacity-95 max-w-3xl mx-auto drop-shadow-md">
              Unified analytics, planning, and predictive insights.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 transition-all hover:shadow-xl">
              ...
              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                <span className="font-semibold text-emerald-600">BrightHorizon Infotech</span> empowers
                enterprises with SAP Analytics Cloud — a complete cloud solution for business
                intelligence, planning, and predictive analytics.
              </p>

              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                Connect live data from SAP and non-SAP sources, create interactive dashboards,
                perform what-if simulations, and leverage AI-driven insights for smarter decisions.
              </p>

              <p className="text-lg leading-relaxed text-slate-700">
                With <span className="font-semibold text-emerald-600">BrightHorizon Infotech</span>,
                transform raw data into actionable intelligence that drives growth and efficiency.
              </p>
            </div>

            {/* Navigation Buttons: Prev | All Services | Next */}
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12 items-center">
              {/* Prev: Mobile Development */}
              <button
              ...
              {/* Next: On-Premise Analytics */}
              <button
                onClick={() => navigate("/services/on-premise-analytics")}
                className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-full font-semibold text-base transition-all duration-300 shadow-md hover:shadow-xl transform hover:scale-105 active:scale-95 w-full sm:w-auto"
              >
                Next: On-Premise Analytics <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </section>
