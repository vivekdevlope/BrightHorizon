        ...
        <section className="flex-1 flex items-center justify-center px-6 md:px-20 py-16 md:py-24">
          <div className="max-w-5xl mx-auto text-center text-white z-10">
            ...
            <p className="text-lg md:text-2xl opacity-95 max-w-3xl mx-auto drop-shadow-md">
              Customer-centric solutions with loyalty and omnichannel engagement.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 transition-all hover:shadow-xl">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-pink-100 text-pink-700 rounded-full flex items-center justify-center">
              ...
              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                <span className="font-semibold text-pink-600">BrightHorizon Infotech</span> helps you
                build lasting customer relationships with SAP CRM and advanced loyalty programs.
              </p>

              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                From 360° customer views to omnichannel service and personalized loyalty rewards,
                we enable seamless sales, marketing, and service automation across all touchpoints.
              </p>

              <p className="text-lg leading-relaxed text-slate-700">
                With <span className="font-semibold text-pink-600">BrightHorizon Infotech</span>,
                turn every interaction into loyalty and every customer into a brand advocate.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12 items-center">
              ...
              >
                <ArrowLeft size={20} /> Prev: SAP Migration
              </button>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-full font-semibold text-base transition-all duration-300 shadow-md hover:shadow-xl transform hover:scale-105 active:scale-95 w-full sm:w-auto"
              >
                Next: Staffing Argumentation <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </section>
