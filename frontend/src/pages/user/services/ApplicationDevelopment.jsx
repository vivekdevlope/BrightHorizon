// src/pages/user/ApplicationDevelopment.jsx
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1587620962725-abab7fe55159?auto=format&fit=crop&w=1600&q=80')",
        }}
      >
        ...
        <section className="flex-1 flex items-center justify-center px-6 md:px-20 py-16 md:py-24">
          <div className="max-w-5xl mx-auto text-center text-white z-10">
            ...
            <p className="text-lg md:text-2xl opacity-95 max-w-3xl mx-auto drop-shadow-md">
              Custom SAP applications tailored to empower your business.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 transition-all hover:shadow-xl">
              ...
              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                <span className="font-semibold text-blue-600">BrightHorizon Infotech</span> provides
                custom SAP application development services to help businesses optimize their
                SAP systems and processes for maximum efficiency and performance.
              </p>

              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                Our skilled developers design, develop, and implement custom SAP applications
                tailored to your specific business needs — empowering you to streamline
                operations, reduce costs, and improve decision-making.
              </p>

              <p className="text-lg leading-relaxed text-slate-700">
                Partnering with <span className="font-semibold text-blue-600">BrightHorizon Infotech</span>
                means transforming your SAP landscape into a powerful business enabler,
                helping you stay competitive and future-ready.
              </p>
            </div>

            {/* Navigation Buttons – Next Button Removed */}
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12 items-center">
              ...
              >
                <ArrowLeft size={20} /> Prev: Application Support
              </button>
              ...
              {/* Next Button REMOVED – This is the last page */}
            </div>
          </div>
        </section>
