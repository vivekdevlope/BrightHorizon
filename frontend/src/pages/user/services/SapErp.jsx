        ...
        <section className="flex-1 flex items-center justify-center px-6 md:px-20 py-16 md:py-24">
          <div className="max-w-5xl mx-auto text-center text-white z-10">
            ...
            <p className="text-lg md:text-2xl opacity-95 max-w-3xl mx-auto drop-shadow-md">
              End-to-end ERP implementation and optimization.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 transition-all hover:shadow-xl">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-orange-100 text-orange-700 rounded-full flex items-center justify-center">
              ...
              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                <span className="font-semibold text-orange-600">BrightHorizon Infotech</span> specializes
                in full lifecycle SAP ERP implementations — from strategy and design to
                deployment, migration, and continuous improvement.
              </p>

              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                Whether upgrading from ECC to S/4HANA or implementing greenfield, we deliver
                standardized processes, real-time insights, and seamless integration across
                finance, logistics, and operations.
              </p>

              <p className="text-lg leading-relaxed text-slate-700">
                With <span className="font-semibold text-orange-600">BrightHorizon Infotech</span>,
                your ERP becomes the digital core of a truly intelligent enterprise.
              </p>
            </div>

            {/* Navigation Buttons – With All Services Button */}
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12 items-center">
              ...
              >
                <ArrowLeft size={20} /> Prev: Cloud Analytical Services
              </button>

              {/* Back to All Services (Center) */}
              <button
              ...
              {/* Next */}
              <button
                onClick={() => navigate("/services/sap-migration")}
                className="inline-flex items-center gap-2 bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-full font-semibold text-base transition-all duration-300 shadow-md hover:shadow-xl transform hover:scale-105 active:scale-95 w-full sm:w-auto"
              >
                Next: SAP Migration <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </section>
