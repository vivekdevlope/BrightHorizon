// src/pages/user/CloudAnalyticalServices.jsx
import React, { useEffect } from "react";
import { useNavigate } from "react-router-dom";
import { Cloud, ArrowLeft, ArrowRight } from "lucide-react";

const CloudAnalyticalServices = () => {
        ...
        <section className="flex-1 flex items-center justify-center px-6 md:px-20 py-16 md:py-24">
          <div className="max-w-5xl mx-auto text-center text-white z-10">
            <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight drop-shadow-xl">
              Cloud Analytical Services
            </h1>
            <p className="text-lg md:text-2xl opacity-95 max-w-3xl mx-auto drop-shadow-md">
              Scalable cloud analytics with real-time insights and self-service BI.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 transition-all hover:shadow-xl">
              ...
              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                <span className="font-semibold text-teal-600">BrightHorizon Infotech</span> delivers
                enterprise-grade cloud analytics using SAP Datasphere, SAP Analytics Cloud,
                and leading cloud platforms (AWS, Azure, GCP).
              </p>

              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                Build scalable data warehouses in the cloud, enable self-service dashboards
                with live connectivity, and deploy predictive analytics models — all with
                real-time data processing and AI-powered insights.
              </p>

              <p className="text-lg leading-relaxed text-slate-700">
                With <span className="font-semibold text-teal-600">BrightHorizon Infotech</span>,
                your analytics are agile, cost-effective, and ready for the future.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12 items-center">
              ...
              >
                <ArrowLeft size={20} /> Prev: On-Premise Analytics
              </button>
              ...
              >
                Next: SAP ERP (ECC & S/4HANA) <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </section>
...
export default CloudAnalyticalServices;