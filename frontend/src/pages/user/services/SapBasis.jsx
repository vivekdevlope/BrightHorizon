  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1558494949-ef646e98691f?auto=format&fit=crop&w=1600&q=80')",
        }}
      >
        ...
        <section className="flex-1 flex items-center justify-center px-6 md:px-20 py-16 md:py-24">
          <div className="max-w-5xl mx-auto text-center text-white z-10">
            ...
            <p className="text-lg md:text-2xl opacity-95 max-w-3xl mx-auto drop-shadow-md">
              Secure, reliable, and high-performing SAP infrastructure.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 transition-all hover:shadow-xl">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-red-100 text-red-700 rounded-full flex items-center justify-center">
              ...
              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                <span className="font-semibold text-red-600">BrightHorizon Infotech</span> provides
                expert SAP Basis administration to ensure your SAP systems are stable, secure,
                and optimized for peak performance.
              </p>

              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                From HANA database management and system monitoring to security patching,
                transport management, and cloud migrations — we handle it all with precision.
              </p>

              <p className="text-lg leading-relaxed text-slate-700">
                With <span className="font-semibold text-red-600">BrightHorizon Infotech</span>,
                your SAP foundation is rock-solid, compliant, and ready for the future.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12 items-center">
              ...
              >
                <ArrowLeft size={20} /> Prev: SAP CRM
              </button>
              ...
              {/* Next */}
              <button
                onClick={() => navigate("/services/staffing-augmentation")}
                className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-full font-semibold text-base transition-all duration-300 shadow-md hover:shadow-xl transform hover:scale-105 active:scale-95 w-full sm:w-auto"
              >
                Next: Staffing Augmentation <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </section>
