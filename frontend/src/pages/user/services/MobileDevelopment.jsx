// src/pages/user/MobileDevelopment.jsx
      ...
      <div className="relative min-h-screen flex flex-col pt-20">
        ...
        <section className="flex-1 flex items-center justify-center px-6 md:px-20 py-16 md:py-24">
          <div className="max-w-5xl mx-auto text-center text-white z-10">
            ...
            <p className="text-lg md:text-2xl opacity-95 max-w-3xl mx ticksauto drop-shadow-md">
              SAP-integrated mobile apps for field and remote users.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12 transition-all hover:shadow-xl">
              ...
              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                <span className="font-semibold text-purple-600">BrightHorizon Infotech</span> builds
                native and hybrid mobile applications that seamlessly connect to your SAP
                backend — enabling real-time access from anywhere.
              </p>

              <p className="text-lg leading-relaxed text-slate-700 mb-4">
                Using SAP Mobile Services, Fiori for Mobile, React Native, and Flutter, we
                deliver offline-capable, secure, and push-enabled apps for field service,
                sales, inventory, and approvals.
              </p>

              <p className="text-lg leading-relaxed text-slate-700">
                With <span className="font-semibold text-purple-600">BrightHorizon Infotech</span>,
                empower your mobile workforce with enterprise-grade tools in their pocket.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-12 items-center">
              ...
              >
                <ArrowLeft size={20} /> Prev: Product Engineering
              </button>
              ...
              >
                Next: SAP Analytics Cloud <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </section>
