    ...
    <>
      ...
      <div className="relative min-h-screen flex flex-col pt-20">
        ...
        <section className="bg-white py-16 px-6 md:px-20">
          <div className="max-w-4xl mx-auto text-gray-800 leading-relaxed space-y-8">
            <p className="text-lg animate-fadeIn">
              ...
              , our vision is to be a leading SAP consulting firm that helps
              businesses achieve their full potential.
            </p>

            <p className="text-lg animate-fadeIn animation-delay-200">
              We believe in leveraging the latest technologies and best practices
              to deliver innovative and comprehensive solutions that drive growth
              and efficiency.
            </p>

            <p className="text-lg animate-fadeIn animation-delay-400">
              Our goal is to be recognized for our expertise, reliability, and
              exceptional customer service, and to build long-lasting partnerships
              with our clients.
            </p>

            <p className="text-lg animate-fadeIn animation-delay-600">
              Ultimately, we envision a future where businesses can rely on{" "}
              <span className="font-semibold text-blue-600">
                BrightHorizon Infotech
              </span>{" "}
              to provide the highest quality SAP solutions and services that
              enable them to thrive in an ever-changing world.
            </p>
          </div>
        </section>
        ...
        <div className="bg-gray-100 border-t border-gray-200 py-8 text-center">
          ...
          >
            Next: Mission <ArrowRight size={22} />
          </button>
        </div>
      </div>
    </>
